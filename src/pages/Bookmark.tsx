                        ...
                        <CardActionArea href={"item/" + item.id}>
                          ...
                          {item.state === 1 && (
                            <Typography
                              sx={{ fontsize: "16px" }}
                              component="div"
                              className={styles.before_lending}
                            >
                              貸出開始前
                            </Typography>
                          )}
                      ...
                      <Card sx={{ maxWidth: 500 }}>
                        <CardActionArea href={"knowledge/" + knowledge.id}>
                          ...
                          <CardContent sx={{ padding: 1 }}>
                            ...
                            <AvatarGroup
                              total={knowledge.participants?.length ?? 0}
                              className={styles.avatar}
                            >
                              {(knowledge.participants ?? []).map(
                                (participant: {
                                  name: string;
                                  img: string;
                                }) => (
                              ...
                              {(!knowledge.participants ||
                                knowledge.participants.length === 0) && (
